...
const Modal = class {
    constructor(hostRef) {
        ...
        this.onBackdropTap = () => {
            this.dismiss(undefined, _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["B"]);
        };
        this.onDismiss = (ev) => {
            ev.stopPropagation();
            ev.preventDefault();
    ...
    async present() {
        ...
        this.usersElement = await Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_9__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);
        await Object(_index_3528f139_js__WEBPACK_IMPORTED_MODULE_10__["d"])(this.usersElement);
        await Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
    ...
    async dismiss(data, role) {
        ...
        const iosAni = (this.animation === undefined || (role === _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["B"] || role === undefined)) ? iosLeaveAnimation : undefined;
        const enteringAnimation = _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["h"].get(this) || [];
        const dismissed = await Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["f"])(this, data, role, 'modalLeave', iosAni, mdLeaveAnimation, this.presentingElement);
        if (dismissed) {
            await Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this.delegate, this.usersElement);
            if (this.animation) {
    ...
    render() {
        const mode = Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this);
        return (Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["H"], { "no-router": true, "aria-modal": "true", class: Object.assign({ [mode]: true, [`modal-card`]: this.presentingElement !== undefined }, Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.cssClass)), style: {

...
const routes = [
    ...
    {
        path: 'marcas',
        loadChildren: () => Promise.all(/*! import() | marcas-marcas-module */[__webpack_require__.e("common"), __webpack_require__.e("marcas-marcas-module")]).then(__webpack_require__.bind(null, /*! ./marcas/marcas.module */ "./src/app/marcas/marcas.module.ts")).then(m => m.MarcasPageModule)
    },
    {
        path: 'marcas/detalle/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | marcas-marcas-detalle-detalle-module */ "common").then(__webpack_require__.bind(null, /*! ./marcas/marcas/detalle/detalle.module */ "./src/app/marcas/marcas/detalle/detalle.module.ts")).then(m => m.DetallePageModule)
    }
];
...
module.exports = __webpack_require__(/*! /home/hdegracia/Spring5/ionic/electronicApp/src/main.ts */"./src/main.ts");

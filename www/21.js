...
/* harmony import */ var _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-992cb809.js */ "./node_modules/@ionic/core/dist/esm/overlays-992cb809.js");
...
const Datetime = class {
    ...
    async open() {
        ...
        const picker = await _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["p"].create(pickerOptions);
...
const Picker = class {
    constructor(hostRef) {
        ...
        this.animated = true;
        this.onBackdropTap = () => {
            this.dismiss(undefined, _overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["B"]);
        };
     ...
     */
    async present() {
        await Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["f"])(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the picker did dismiss.
     */
    onDidDismiss() {
        return Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["g"])(this.el, 'ionPickerDidDismiss');
    }
    /**
     * Returns a promise that resolves when the picker will dismiss.
     */
    onWillDismiss() {
        return Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["g"])(this.el, 'ionPickerWillDismiss');
    }
    /**
    ...
    async callButtonHandler(button) {
        if (button) {
            ...
            const rtn = await Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_4__["s"])(button.handler, this.getSelected());
            if (rtn === false) {
